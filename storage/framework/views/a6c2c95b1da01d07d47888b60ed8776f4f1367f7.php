    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="w-100 d-flex flex-column flex-shrink-0 p-3 bg-light min-vh-100">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="py-1">
                    <a href="<?php echo e(route('admin.salary', $group->id)); ?>" class="btn btn-primary w-100">給与一覧</a>
                </li>
                <li class="py-1">
                    <form>
                ...
                <li class="py-1 mt-4">
                    <a href="<?php echo e(route('admin.edit.onsites', $group->id)); ?>"
                       class="btn btn-info w-100 text-white">現場管理</a>
                </li>
                <li class="py-1">
                    <a href="<?php echo e(route('admin.members', $group->id)); ?>" class="btn btn-info w-100 text-white">作業員管理</a>
                </li>
                <li class="py-1">
                    <a href="<?php echo e(route('admin.edit.group', $group->id)); ?>"
...
<?php /**PATH C:\xampp\htdocs\PracticeLaravel\onsitecalendar\resources\views/admins/components/sidebar.blade.php ENDPATH**/ ?>
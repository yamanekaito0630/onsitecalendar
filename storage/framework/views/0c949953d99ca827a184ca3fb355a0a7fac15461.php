                        ...
                        <div class="row">
                            <div class="col-lg-3 my-1">
                                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                                        data-bs-target="#dailyAllowanceModal<?php echo e($member['user_id']); ?>">日当設定
                                </button>
                            </div>
                            <div class="col-lg-3 my-1">
                                <a href="<?php echo e(route('admin.members.detail', [$group->id, $member->id])); ?>" class="btn btn-success w-100" >日当履歴</a>
                            </div>
                            <div class="col-lg-3 my-1">
                                <button type="submit" class="btn btn-warning w-100" data-bs-toggle="modal"
                                        data-bs-target="#isAdminModal<?php echo e($member['user_id']); ?>" <?php echo e($member['is_admin'] ? 'disabled' : ''); ?>>
                                    管理権限
                                </button>
                            </div>
                            <div class="col-lg-3 my-1">
                                <button type="button" class="btn btn-danger w-100" data-bs-toggle="modal"
                                        data-bs-target="#employeeDeleteModal<?php echo e($member['user_id']); ?>" <?php echo e($member['is_admin'] ? 'disabled' : ''); ?>>
                                    退会
                                </button>
                            </div>
                    ...
                    <div class="modal fade" id="dailyAllowanceModal<?php echo e($member['user_id']); ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo e(route('admin.store.salary', $group->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="<?php echo e(route('admin.update.mode', $group->id)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                    ...
                    <div class="modal fade" id="employeeDeleteModal<?php echo e($member['user_id']); ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">しない</button>
                                    <form action="<?php echo e(route('admin.delete.member', $group->id)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="member-id" value="<?php echo e($member['user_id']); ?>">
...
<?php echo $__env->make('admins.layouts.create_join_group_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PracticeLaravel\onsitecalendar\resources\views/admins/employee_management.blade.php ENDPATH**/ ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="<?php echo e(route('admin.delete', $group->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="onsite-delete" value="<?php echo e(true); ?>">
...
<?php echo $__env->make('admins.layouts.create_join_group_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PracticeLaravel\onsitecalender\resources\views/admins/onsite_management.blade.php ENDPATH**/ ?>
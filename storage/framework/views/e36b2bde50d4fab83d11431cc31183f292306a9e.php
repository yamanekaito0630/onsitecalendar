<?php $__env->startSection('content'); ?>
    <div class="box mx-auto p-5 bg-gray-100 mt-5 shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <form action="<?php echo e(route('admin.update.group', $group->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="<?php echo e(route('admin.delete.group', $group->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admins.layouts.create_join_group_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PracticeLaravel\onsitecalendar\resources\views/admins/group_edit.blade.php ENDPATH**/ ?>